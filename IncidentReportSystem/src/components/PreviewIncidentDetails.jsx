...
import {
  ...
  import LexMariaAssessment from "./LexMariaAssessment";
...
const PreviewIncidentDetails = ({ row, onCancel, onSave,  open,
    onClose,
    formRef,
    formValues,
    setFormValues,
  ...
  return (
    <>
    <Box component="div" open={open} onClose={handleDialogClose} fullWidth sx={{margin:"20px"}} >
     ...
     <Box sx={{
      ...
      marginTop: 2,
        ...
        >
          Preview Report Details <button type="button" onClick={onCancel}>
          Back to Incidents
        </button>
...
export default PreviewIncidentDetails;
